...
const WalletModal = ({ open, handleClose, wallets, lastWallet, setWallet, getLeatherAddress, getAddress, getAddressOptions, getUnisatAddress, modalContainerClass = "bwa-bg-black bwa-bg-opacity-75 bwa-h-screen bwa-w-full bwa_center", modalContentClass = "bwa-bg-bwa_secondary bwa-p-6 bwa-min-w-[50%] bwa-relative bwa-shadow-xl bwa-rounded-xl", closeButtonClass = "bwa-rounded bwa_font-bold bwa-bg-gray-700 hover:bwa-bg-red-500 bwa-bg-opacity-50 bwa-text-gray-300 bwa-p-2 bwa-cursor-pointer", headingClass = "bwa_modalHeading bwa-text-bwa_accent", walletItemClass = "bwa-w-full bwa-cursor-pointer bwa-border bwa-border-transparent bwa-p-4 bwa-rounded-xl bwa-transition-all", walletImageClass = "bwa-w-[50px]", walletLabelClass = "bwa-text-white bwa-font-bold bwa-capitalize bwa-text-xl bwa-pl-3 bwa-text-center", icon = "https://ordinalnovus.com/logo_default.png", iconClass = "bwa-w-[100px]", iconContainerClass = "bwa-w-full bwa_center", }) => {
